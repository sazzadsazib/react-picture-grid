...
export declare const BackdropColor: () => JSX.Element;
export declare const ShowImageInfo: () => JSX.Element;
export declare const ImageinfoWithCount: () => JSX.Element;
export declare const closeOnClick: () => JSX.Element;
...
export declare const WithNoData: () => JSX.Element;
